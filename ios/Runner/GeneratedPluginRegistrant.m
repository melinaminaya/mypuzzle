...
#if __has_include(<games_services/GamesServicesPlugin.h>)
#import <games_services/GamesServicesPlugin.h>
#else
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [GamesServicesPlugin registerWithRegistrar:[registry registrarForPlugin:@"GamesServicesPlugin"]];
